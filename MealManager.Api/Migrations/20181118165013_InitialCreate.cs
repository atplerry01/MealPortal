    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MealAssignments", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DepartmentMealProfilings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DepartmentMealProfilings_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DepartmentMealProfilings_MealAssignments_MealAssignmentId",
                        column: x => x.MealAssignmentId,
                        principalTable: "MealAssignments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "UserMealProfilings",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserMealProfilings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserMealProfilings_DepartmentMealProfilings_DepartmentMealProfilingId",
                        column: x => x.DepartmentMealProfilingId,
                        principalTable: "DepartmentMealProfilings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserMealProfilings_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MealTransactions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DepartmentMealProfilings_DepartmentId",
                table: "DepartmentMealProfilings",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_DepartmentMealProfilings_MealAssignmentId",
                table: "DepartmentMealProfilings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MealTransactions_UserId",
                table: "MealTransactions",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserMealProfilings_DepartmentMealProfilingId",
                table: "UserMealProfilings",
                column: "DepartmentMealProfilingId");

            migrationBuilder.CreateIndex(
                name: "IX_UserMealProfilings_UserId",
                table: "UserMealProfilings",
                column: "UserId");
        }
